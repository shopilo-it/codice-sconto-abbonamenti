#!/usr/bin/env python3
"""
Recupero codici sconto Abbonamenti.it da shopilo.it
Sursa: https://shopilo.it/negozi/abbonamenti.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/abbonamenti.it"
STORE_NAME = "Abbonamenti.it"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Abbonamenti.it da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-abbonamenti)"
    }
    try:
